...
from pyhub.llm.exceptions import ModelNotSupportedError
...
class TestOpenAIImageGeneration:
    ...
    def test_generate_image_basic(self, mock_openai):
        ...
        mock_response.data = [
            Mock(
                url="https://dalle.com/image123.png",
                revised_prompt="Enhanced: A beautiful sunset"
            )
        ]
    ...
    def test_generate_image_with_options(self, mock_openai):
        ...
        mock_response.data = [
            Mock(
                url="https://dalle.com/image456.png",
    ...
    async def test_generate_image_async(self, mock_async_openai):
        ...
        mock_response.data = [
            Mock(
                url="https://dalle.com/async_image.png",
                revised_prompt="Enhanced: Async generated image"
            )
        ]
...
class TestAsyncImageGeneration:
    ...
    async def test_generate_image_async_basic(self, mock_openai):
        ...
        mock_response.data = [
            Mock(
                url="https://dalle.com/async-image.png",
                revised_prompt="Enhanced async prompt"
            )
        ]
        mock_client.images.generate.return_value = mock_response
