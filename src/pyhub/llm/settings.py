...
class LLMSettings:
    ...
    def __init__(self):
        ...
        # Base URLs
        self.openai_base_url = os.getenv("OPENAI_BASE_URL") or os.getenv("PYHUB_LLM_OPENAI_BASE_URL") or "https://api.openai.com/v1"
        ...
        self.upstage_base_url = os.getenv("UPSTAGE_BASE_URL") or os.getenv("PYHUB_LLM_UPSTAGE_BASE_URL") or "https://api.upstage.ai/v1"
        self.ollama_base_url = os.getenv("OLLAMA_BASE_URL") or os.getenv("PYHUB_LLM_OLLAMA_BASE_URL") or "http://localhost:11434"
