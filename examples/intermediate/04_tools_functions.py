...
def search_web(query: str, max_results: int = 3) -> str:
    ...
    mock_results = {
        "파이썬": [
            ...
            {"title": "Python 튜토리얼", "url": "https://docs.python.org/ko/3/tutorial/", "snippet": "파이썬 공식 튜토리얼"},
        ],
        "머신러닝": [
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "expression": {
                        "type": "string",
                        "description": "계산할 수식 (예: 2+2, sqrt(16), sin(3.14/2))"
                    }
                },
                "required": ["expression"]
            }
    ...
    for request in requests:
        ...
        try:
            reply = llm.ask_with_tools(
                request,
                tools=[risky_tool],
                tool_functions={"risky_function": risky_function}
            )
