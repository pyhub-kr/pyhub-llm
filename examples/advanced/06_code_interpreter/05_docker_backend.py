...
def remote_docker_example():
    ...
    try:
        ...
        response = llm.ask_with_tools(prompt, tools=[code_tool])
        print(response.text)
...
def docker_vs_local_comparison():
    ...
    response_local = llm.ask_with_tools(test_code, tools=[local_tool])
    ...
    try:
        ...
        response_docker = llm.ask_with_tools(test_code, tools=[docker_tool])
