...
class ConversationViewSet(viewsets.ModelViewSet):
    ...
    def send_message(self, request, pk=None):
        ...
        try:
            ...
            return Response(
                {"user_message": MessageSerializer(user_message).data, "ai_message": MessageSerializer(ai_message).data}
            )
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            image_analysis = ImageAnalysis.objects.create(
                user=request.user if request.user.is_authenticated else None, image=image, question=question
            )
...
class StatsView(View):
    ...
    def get(self, request):
        ...
        # 모델별 사용량
        model_usage = (
            ChatHistory.objects.values("model_used")
